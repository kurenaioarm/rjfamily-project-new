...
<div class="site-login">
    <div class="" align="center">
        <div class="form-group mb-12">
            ...
            <?= $form->field($model, 'username')->textInput(['autofocus' => true , 'placeholder' => 'ระบุ : ชื่อผู้ใช้งาน' , 'maxlength' => '13' , 'autocomplete' => 'off', 'onkeypress'=>'return MyKeyUsername(event);' ])->label(false)  ?>

            <?= $form->field($model, 'password')->passwordInput(['placeholder' => 'ระบุ : รหัสผ่าน','id'=>'txtpassword','onkeypress'=>'return MyKeyPassword(event);'])->label(false)  ?>
...
<!--             $form->field($model, 'rememberMe')->checkbox(['checked' => false]) -->
            ...
            <div style="display:none">
                <span id="replace_target"><img src="https://rjfamily.rajavithi.go.th/DashboardHR/images/Loading.gif" style="width: 100%; height: 100%"></span>
            </div>
            <!--======================================================================================================================================================-->

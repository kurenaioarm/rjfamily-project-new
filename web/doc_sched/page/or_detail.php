...
//'2022-12-26'
$objListResult = $orClass->queDate('EYE', ($arrDate[2] - 543) . '-' . $arrDate[1] . '-' . $arrDate[0]);
...
<section class="section home-feature">
    <div class="container">
        <div class="d-flex justify-content-center" style="flex-direction: column; align-items: center;">
            <h5 class="title"><span class="badge badge-pill badge-dark">คิวห้องผ่าตัด วันที่ <?php echo $_POST['orDate']; ?></span></h5>
        </div>
        <!-- <div>
            <pre>
                <?php
                // print_r($arrQueueByRoom);
                ?>
            </pre>
        </div> -->
        <div class="card">
                ...
                <ul class="nav nav-pills" id="pills-tab" role="tablist">
                    ...
                    ?>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link <?php echo $menuTabCss; ?>" id="pills-patho-tab" href="" data-toggle="pill" data-target="#tab<?php echo $key; ?>" role="tab" aria-controls="pills-patho" aria-selected="<?php echo $menuTabAria; ?>">
                                <?php echo $roomName; ?>
                                            ...
                                            <table class="table table-head-fixed" style="">
                                                <thead>
                                                    <tr class="text-center">
                                                        ...
                                                        <th><span class="badge badge-pill badge-light">Surgeon</span></th>

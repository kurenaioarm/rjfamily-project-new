...
<?php 
$g='key: 0, n: "daddy summer", s: "M", m: -10, f: -11, ux: 1';
$a='key: 1, n: "mommy summer", s: "F", m: -12, f: -13';
?>
...
foreach ($geno->json_data as $value) { 
  if($value->GENO_SEX=='M'){
      $n='key:'.$value->GENO_KPER.' , n: "'.$value->GENO_NAME.'", s: "'.$value->GENO_SEX.'", m: '.$value->GENO_MOTH.', f: '.$value->GENO_FATH.' , ux: '.$value->GENO_REAC.', a: ["'.$value->GENO_DEAD.'"]' ;
    }else if($value->GENO_SEX=='F'){
      $n='key:'.$value->GENO_KPER.' , n: "'.$value->GENO_NAME.'", s: "'.$value->GENO_SEX.'", m: '.$value->GENO_MOTH.', f: '.$value->GENO_FATH.' , vir: '.$value->GENO_REAC.', a: ["'.$value->GENO_DEAD.'"]' ;
    }
?>
        {<?php echo  $n;?>},
<?php } ?>
/*     
        ...
        <?php echo $_SESSION['hlkey'];?> /* focus on this person */);
    }

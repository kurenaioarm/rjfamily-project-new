...
use RJFamily\assets\LoginAsset;
        ...
        <div class="container-fluid" style="width: 80% ;">
            <div class="card login-card">
                <div class="row no-gutters">
                    <div class="col-lg-8">
                        <img src="https://rjfamily.rajavithi.go.th/themes_assets/login-template-0/assets/images/login-RJMedicalRecord.png" alt="login"  style="width: 100% ; height: 100%">
                    </div>
                    <div class="col-lg-4" align="center" >
                        <div class="card-body" >
                            <div class="brand-wrapper">
                                <img src="https://rjfamily.rajavithi.go.th/themes_assets/login-template-1/assets/images/RJFamily.png" alt="logo" class="logo" style="width: 70% ; height: 70%">
                            </div>
                            <br>
                            <?= $content ?>
                        </div>
